...
| 🖨️ **POS 出單機硬體指南** | `POS機台列印設定.md` | 熱感小票機與網路列印詳細設定步驟 |
| 👨‍💻 **開發者技術手冊** | `DEVELOPER_HANDOVER.md` | 系統技術架構、業務邏輯與雙店維運手冊 |
| ☁️ **Vercel 雲端部署交接** | `vercel_deployment_handover_guide.md` | Vercel 帳號授權、專案連結與環境變數 SOP |
